...
class SubmitWindow(QMainWindow):
    def __init__(self,eye_track,switch_duration,app_switching_percent,verified_frames,eye_sus,total_frames,test_id,student_email):
    ...
    def submit_report(self):
        isSuccess=put_reports(self.test_id,self.student_email,self.app_switching_percent,self.face_sus_percent,self.eye_sus_percent)
